...
\textit{Anchor sentences} (each individually flips the outcome wrong-to-right when removed):
\begin{itemize}\itemsep1pt
  \item Anchor 1: ``To accurately calculate Ariadne's total sales for March and April, we need specific data regarding her sales for those months.'' (Turn 1, sentence 0)
  \item Anchor 2: ``Since the actual sales figures are not provided in your question, I will outline the steps to calculate her total sales once you have the necessary data.'' (Turn 1, sentence 1)
\end{itemize}
\end{quote}

...
DROP_FRAC = float(os.environ.get('DROP_FRAC', '0.5'))  # fraction of EARLY asst messages to drop
    ...
    def run(self, verbose=False, save_log=True):
        ...
        while not is_completed:
            ...
            if is_last_turn:
                ...
                conversation = self._drop_early_assistant(conversation)

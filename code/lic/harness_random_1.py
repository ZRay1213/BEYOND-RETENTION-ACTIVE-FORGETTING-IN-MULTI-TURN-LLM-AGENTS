...
DIRECTIVE_TEMPLATES = {
    'CONTINUE': None,
    'VERIFY': (
        'Before you reply, check your last numerical answer carefully by following the steps and only using the information the user provided. If there is any math involved, redo the calculations. If you spot any mistakes, fix them right away.'
    ),
    'CLARIFY': (
        'Key instruction: Prior to responding, pose one brief clarifying question about the latest fact to the user. Answer solely with the question.'
    ),
    'RESET': (
        'Crucial instruction: Remove any initial response you might have provided. Go through all the user information again, note every detail, and suggest a new approach. If an earlier statement conflicts with a new piece of information, eliminate it.'
    ),
    'CONCLUDE': (
        'Critical instruction: Cease requesting additional details. Provide your final numerical answer immediately in the format \boxed{...} using the information you have.'
    ),

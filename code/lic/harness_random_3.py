...
DIRECTIVE_TEMPLATES = {
    'CONTINUE': None,
    'VERIFY': (
        'Before you respond, check your last numerical answer carefully by following the steps and using only the information the user provided. If there is any math involved, redo the calculations. Fix any mistakes you discover.'
    ),
    'CLARIFY': (
        'Before responding, pose one brief question to the user about the latest fact. Answer with just the question.'
    ),
    'RESET': (
        'Crucial instruction: Get rid of any partial response you might have already provided. Go back to the beginning and carefully review all the information given by the user. Write down every fact and suggest a new approach. If an old statement goes against a new piece of information, remove it.'
    ),
    'CONCLUDE': (
        'Critical instruction: Cease requesting additional details. Provide your final numerical answer with certainty in the format \boxed{...} based on the information available to you.'
    ),

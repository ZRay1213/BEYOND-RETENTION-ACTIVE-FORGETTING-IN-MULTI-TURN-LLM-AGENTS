...
DIRECTIVE_TEMPLATES = {
    'CONTINUE': None,
    'VERIFY': (
        'Before you respond, check your previous numerical answer carefully by following the steps and using only the information the user provided. Do the math again if needed. If you notice any mistakes, fix them now.'
    ),
    'CLARIFY': (
        'Before responding, pose one brief question to the user about the latest fact mentioned. Answer only with the question.'
    ),
    'RESET': (
        'Critical instruction: Get rid of any initial response you might have provided. Go through all the user information again, write down every detail, and suggest a new approach. If an old statement goes against a new piece of information, remove it.'
    ),
    'CONCLUDE': (
        'Crucial instruction: Cease requesting additional details. Provide your final numerical answer with certainty in the format \boxed{...} based on current knowledge.'
    ),

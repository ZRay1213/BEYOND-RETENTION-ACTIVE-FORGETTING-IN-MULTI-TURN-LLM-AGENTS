...
DIRECTIVE_TEMPLATES = {
    ...
    'REFRAME': (
        'Important directive: Reconstruct the problem in simpler terms using only the facts the user has provided. '
        'Do not solve the problem, just reframe it.'
    ),
    'RESET': (
...
CONTROLLER_SYSTEM = (
    ...
    "  REFRAME  — reconstruct the problem in simpler terms (use when assistant is stuck and clarification did not help)\n"

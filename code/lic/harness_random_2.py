...
DIRECTIVE_TEMPLATES = {
    'CONTINUE': None,
    'VERIFY': (
        'Before you respond, check your previous numerical answer carefully by following each step and using only the information provided by the user. Recalculate any math if needed. If you notice any discrepancies, fix them now.'
    ),
    'CLARIFY': (
        'Before responding, pose one brief question to the user about the most recent fact. Answer only with the question.'
    ),
    'RESET': (
        'Key instruction: Get rid of any initial response you might have provided. Go through all the information given by the user again from the beginning, note down every detail, and suggest a new approach. If an earlier statement goes against a new piece of information, remove it.'
    ),
    'CONCLUDE': (
        'Critical instruction: Cease requesting additional details. Provide your optimal final numerical answer immediately in the format \boxed{...} using the information you have.'
    ),

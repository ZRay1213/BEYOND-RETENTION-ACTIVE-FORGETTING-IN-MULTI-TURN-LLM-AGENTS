...
DIRECTIVE_TEMPLATES = {
    'CONTINUE': None,
    'VERIFY': (
        'Before responding, carefully verify your previous numerical answer by recomputing any steps '
        'using only the explicitly stated facts. Correct any inconsistencies immediately.'
    ),
    'CLARIFY': (
        'Before proceeding, ask the user ONE concise clarifying question about the most recent fact '
        'to ensure all necessary details are accounted for.'
    ),
    'RESET': (
        'Discard any previous answers or assumptions. Re-examine all provided information, list each '
        'fact, and propose a fresh approach, dropping any claims that contradict new facts.'
    ),
    'CONCLUDE': (
        'Stop requesting additional information. Based solely on the available facts, commit to your '
        'final numerical answer in the form \\boxed{...}.'
    ),

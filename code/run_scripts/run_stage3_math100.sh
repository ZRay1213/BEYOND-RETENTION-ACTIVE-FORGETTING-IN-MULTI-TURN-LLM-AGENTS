...
LOGDIR=${LOGDIR:-logs_stage3_math100}
N=${N:-3}
WORKERS=${WORKERS:-6}
echo "[run_stage3_math100] sched=$SCHED dataset=$DATASET logdir=$LOGDIR N=$N workers=$WORKERS"
/root/miniconda3/bin/python run_simulations_controlled.py \
